...
const Question2 = () => {
  ...
  return (
    ...
    <Card.Body>
      <Card.Title className="text-end">2/5</Card.Title>
     ...
     2. How fair are the prices compared to similar retailers?
      ...
      <Col className='d-flex  justify-content-evenly pt-5'>
        ...
        <Button variant="outline-primary"onClick={()=>{navigate('/1')}}>Previous</Button>
        <Button variant="outline-warning"onClick={()=>{navigate('/3')}}>skip</Button>
